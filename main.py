...
class Board(Canvas):
    ...
    def create_objects(self):
        self.create_image(self.dot_x, self.dot_y,
    ...
    def locate_dot(self):
        ...
        self.create_image(self.dot_x, self.dot_y, image=self.dot, anchor=NW,
                          tag='dot')

    def do_move(self):
        bodies = self.find_withtag('body')
        head = self.find_withtag('head')
    ...
    def check_collisions(self):
        ...
        if x1 < 0 or x1 > WIDTH-DOT_SIZE:
            self.in_game = False
        if y1 < 0 or y1 > HEIGHT-DOT_SIZE:
            self.in_game = False
    ...
    def game_over(self):
        ...
        self.create_text(self.winfo_width()/2, self.winfo_height()/2,
                         text='Game Over', font=('Bauhaus 93', '24'),
                         fill='white')
